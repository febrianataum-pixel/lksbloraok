    ...
    <>
      ...
      <div className="md:hidden flex items-center justify-between bg-white border-b border-slate-200 text-slate-800 p-4 sticky top-0 z-40 shadow-sm">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-lg bg-transparent p-0 overflow-hidden flex items-center justify-center">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-transparent p-0 flex-shrink-0 flex items-center justify-center">
